...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'builtins': [
                ...
                '_keenthemes.templatetags.filters',
...
QTRKS_DEFAULT_COMPANY_NAME = 'Quatriks Yazılım ve Danışmanlık Limited Şirketi'

QTRKS_COMPANY_DEFAULTS = {
    'auth_template' : 'fancy',
    'auth_background' : 'bg3',
    'auth_background_dark' : 'bg9-dark',
    'auth_logo' : 'media/logos/custom-1.png',
    'auth_form_position' : 'left', # Value: right | left

    'sidebar_logo' : 'media/logos/default.svg',
    'sidebar_logo_dark' : 'media/logos/default-dark.svg',
    'sidebar_logo_small' : 'media/logos/default-small.svg',

    'error_background' : 'bg7',
    'error_background_dark' : 'bg7-dark',
}

QRKS_COMPANY_TOOLBAR_BUTTONS = {
    'Rollover' : {
        'btn_href' : '#',
        'btn_bs_toggle' : 'modal',
        'btn_bs_target' : '#kt_modal_create_app',
        'btn_class' : 'btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary',
    },
    'Add Target' : {
        'btn_href' : '#',
        'btn_bs_toggle' : 'modal',
        'btn_bs_target' : '#kt_modal_new_target',
        'btn_class' : 'btn btn-sm fw-bold btn-primary',
    },
}

QTRKS_COMPANY_LIST_VIEW = {
    'member' : {
        'table_headers': ['Name', 'Company', ],
        'table_content': ['Name', 'Company', ],
    },
    'company' : {
        'table_headers': ['Product', 'Category', ],
        'table_content': ['Name', 'Category', ],
    },

    'product' : {
        'table_headers': ['Product', 'Category', 'Price', 'Striked Price',],
        'table_content': ['Name', 'Category', ],
    },
    'category' : {
        'table_headers': ['Product', 'Category', ],
...
QTRKS_COMPANY_EDIT_VIEW = {
    'product' : {
        'page_title': 'Edit Category',
        'content': 'Editing {{content}} for Category',
    }
}
...
KT_THEME_LAYOUT_DIR = 'layout' # Theme layout templates directory
...
KT_THEME_DIRECTION = 'ltr' # Theme Direction || Value: ltr | rtl
